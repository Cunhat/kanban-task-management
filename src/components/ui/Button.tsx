...
const buttonStyles = cva("flex items-center justify-center", {
  variants: {
    intent: {
      ...
      secondary: "text-primary bg-customGrey-100 hover:bg-customGrey-500",
      destructive: "text-white bg-customRed hover:bg-customRedHover",
    },
    fullWidth: { true: "w-full" },
    size: {
      sm: "py-2 px-4 rounded-[20px] text-sm",
      lg: "py-4 px-6 rounded-3xl text-base",
    },
  },
  defaultVariants: {
    intent: "primary",
